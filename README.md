...
```
cd existing_repo
git remote add origin https://git.cs.bham.ac.uk/axm21941/stress-detection-in-it-professionals-using-machine-learning.git
git branch -M main
...
- [ ] [Set up project integrations](https://git.cs.bham.ac.uk/axm21941/stress-detection-in-it-professionals-using-machine-learning/-/settings/integrations)
